...
The Birdieswap Protocol is decentralized and operates in a permissionless manner. Although we may collect and process information about users of the Birdieswap website or the Interface in accordance with this Privacy Policy, we do not have information about all protocol users beyond what is already publicly available and recorded on the blockchain.

This Privacy Policy (the "Privacy Policy") explains how Birdieswap Labs ("we," "our," or "us") collects, uses, and shares information in connection with our Services as well as your rights and choices regarding such information. These terms apply to the Birdieswap website, the Interface, and any other online platform that links to this Privacy Policy (collectively, the "Services").
...
Users can enable or disable cookies through their web browser settings. If you want to learn more about cookies, or how to control, disable, or delete them, please visit http://www.aboutcookies.org for detailed guidance.
...
In compliance with GDPR and CCPA, users may request deletion of off-chain personal data by contacting [legal@birdieswap.com](mailto:legal@birdieswap.com). If we are required by law to retain certain data for legal, tax, or compliance reasons, we will notify users of such retention.

## 9. Children

Our Services are not intended for individuals under the age of 18. We do not knowingly collect personal information from children. If we become aware that a minor has provided personal information, we will take steps to delete such data immediately. If you believe a child has accessed our Services, please contact us at [legal@birdieswap.com](mailto:legal@birdieswap.com). If you are a parent or guardian and believe we have collected personal information in violation of COPPA, please contact us at [legal@birdieswap.com](mailto:legal@birdieswap.com) and we will remove the personal information in accordance with COPPA.
...
If you have any questions or comments about this Privacy Policy, our data practices, or our compliance with applicable law, please contact us by email: [legal@birdieswap.com](mailto:legal@birdieswap.com).
